...
struct PlayerBotBaseInfo
{
	...
	std::queue<PlayerBotCreateInfo> needCreateBots;
...
private:
	...
	PlayerBotCreateInfo BuildCreatePlayerData(bool group, uint8 prof);
	void CreateOncePlayerBot();
	void ResumePlayerBotCreate();
...
private:
	...
	bool m_LastPlayerBotCreateFinished;
